...
### ����9: MSS radar_control.c API�ṹ���ֶβ�ƥ��

**��������**: 2026-01-09  
**����λ��**: `src/mss/source/radar_control.c:235-254`
...
1. **SDK�ṹ���ֶ�����벻ƥ��**��L-SDK 6.x��`MMWave_ProfileComCfg_t`��`MMWave_ProfileTimeCfg_t`�ֶ������������ʹ�õĲ�һ�¡�

2. **ʵ��SDK�ṹ�嶨��**��`C:\ti\MMWAVE_L_SDK_06_01_00_01\source\control\mmwave\mmwave.h`����
   
   **MMWave_ProfileComCfg_t**:
   ```c
   typedef struct MMWave_ProfileComCfg_t
   {
       uint8_t   digOutputSampRate;        // ���� digOutSampleRateMHz
       uint8_t   digOutputBitsSel;
       uint8_t   dfeFirSel;
       uint16_t  numOfAdcSamples;          // ���� numAdcSamples
       float     chirpRampEndTimeus;       // �����ﲻ��startFreqGHz
   ...
   **MMWave_ProfileTimeCfg_t**:
   ...
   {
       float     chirpIdleTimeus;          // ���� idleTimeus
       uint16_t  chirpAdcStartTime;        // ���� adcStartTimeus
       float     chirpTxStartTimeus;
       float     chirpSlope;               // ���� freqSlopeConst
       float     startFreqGHz;             // ��ProfileTimeCfg��
   } MMWave_ProfileTimeCfg;
   ```

3. **CliCfg�ṹ������**��`HealthDetect_CliCfg_t`��û��`channelCfg`��Ա��Ӧ��ʹ��`rxChannelEn`��`txChannelEn`��

**�������**:

�޸�`radar_control.c`�е��ֶ�ӳ�䣬ʹ����SDKʵ�ʽṹ��һ�£�
...
**�ؼ��޸���**:
1. ? `startFreqGHz` �Ƶ� `profileTimeCfg` ��
...
| ������ | �������� | ԭ�� | ������� | ״̬ |
|---------|---------|------|---------|------|
| ����6 | DSS post-buildʧ�� | ȱ�� `memory_hex.cmd` | ����DSS��memory_hex.cmd | ? ���޸� |
| ����7 | System post-buildʧ�� | MSSδ���� | ����ȷ˳�����MSSDSSSystem | ? ����֤ |
| ����8 | Config�ļ��� | ��Сд���� | Windows���ݣ������޸� | ? ��ȷ�� |
| ����9 | MSS API�ṹ���ֶβ�ƥ�� | SDK�ṹ���ֶ���������벻һ�� | ����radar_control.c�ֶ�ӳ�� | ? ���޸� |
...
2. **Clean������Ŀ**
   ```
   Project  Clean...  ѡ������health_detect��Ŀ  Clean
   ```

3. **��˳�����**
   ```
   Step 1: ���� health_detect_6844_mss (�Ҽ�  Build Project)
         Ԥ�ڣ�9������������޸���MSSӦ����ɹ�
   Step 2: ���� health_detect_6844_dss (�Ҽ�  Build Project)
         Ԥ�ڣ�DSSӦ����ɹ�
   Step 3: ���� health_detect_6844_system (�Ҽ�  Build Project)
         Ԥ�ڣ�SystemӦ���ҵ�.rig�ļ�������.appimage
   ```
