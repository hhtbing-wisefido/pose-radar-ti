...
| 章节 | 必读参考 | 备用参考 |
|------|---------|--------|
| **第1章 环境搭建** | SDK安装文档、InCabin Demo User Guide | Migration索引(硬件对比)、TI校准指南 |
...
| **第9章 人数统计** | ⭐ **3D_people_tracking_demo_implementation_guide**、**tracker_layer_tuning**、**people_counting_customization** | Tracking_radar_targets详解 |
