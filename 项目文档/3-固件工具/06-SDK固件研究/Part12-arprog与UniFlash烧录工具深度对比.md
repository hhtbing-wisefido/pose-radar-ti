# Part12 - arprog_cmdline_6844.exe 与 UniFlash 烧录工具深度对比

**文档系列**: MMWAVE_L_SDK深度解析 Part12  
**文档日期**: 2025-12-29  
...
- **Part1-10**: SDK基础组件与示例分析
- **Part11**: （规划中）高级应用开发
- **Part12**: 本文档 - arprog与UniFlash烧录工具对比
- **Part13**: （规划中）Flash布局与启动流程

### 项目文档

- `项目文档/4-测试实验结果/1.烧录偏移量实际测试结果.md` - 烧录偏移量测试
